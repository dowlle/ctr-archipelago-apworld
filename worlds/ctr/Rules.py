...
def set_rules(world: "ctrAPWorld"):
    ...
    add_rule(self.get_entrance("Crash Cove Warp Pad", player),
            lambda state: state.can_reach("N. Sanity Beach", None, player))
    ...
    add_rule(self.get_location("Crash Cove: Trophy Race", player),
             lambda state: state.can_reach_entrance("Crash Cove Warp Pad", player) and state.has("Trophy", player, 0))
    add_rule(self.get_location("Crash Cove: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Crash Cove Warp Pad", player) and state.has("Key", player, 1) and state.can_reach_location("Crash Cove: Trophy Race", player))
    ...
    add_rule(self.get_location("Roo's Tubes: Trophy Race", player),
             lambda state: state.can_reach_entrance("Roo's Tubes Warp Pad", player) and state.has("Trophy", player, 0))
    add_rule(self.get_location("Roo's Tubes: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Roo's Tubes Warp Pad", player) and state.has("Key", player, 1) and state.can_reach_location("Roo's Tubes: Trophy Race", player))
    ...
    add_rule(self.get_location("Mystery Caves: Trophy Race", player),
             lambda state: state.can_reach_entrance("Mystery Caves Warp Pad", player) and state.has("Trophy", player, 1))
    add_rule(self.get_location("Mystery Caves: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Mystery Caves Warp Pad", player) and state.has("Key", player, 1) and state.can_reach_location("Mystery Caves: Trophy Race", player))
    ...
    add_rule(self.get_location("Sewer Speedway: Trophy Race", player),
             lambda state: state.can_reach_entrance("Sewer Speedway Warp Pad", player) and state.has("Trophy", player, 2))
    add_rule(self.get_location("Sewer Speedway: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Sewer Speedway Warp Pad", player) and state.has("Key", player, 1) and state.can_reach_location("Sewer Speedway: Trophy Race", player))
    ...
    add_rule(self.get_location("Ripper Roo Garage: Boss Race", player),
             lambda state: state.can_reach_entrance("Ripper Roo Garage Door", player) and state.has("Trophy", player, 4))
    
    # Skull Rock
    add_rule(self.get_location("Skull Rock: Crystal Bonus Round", player),
             lambda state: state.can_reach_entrance("Skull Rock Warp Pad", player) and state.has("Key", player, 1))
    ...
    add_rule(self.get_location("Red Gem Cup: Gem", player),
             lambda state: state.can_reach_entrance("Red Cup Warp Pad", player) and state.has("Red CTR Token", player, 4))
    add_rule(self.get_location("Green Gem Cup: Gem", player),
             lambda state: state.can_reach_entrance("Green Cup Warp Pad", player) and state.has("Green CTR Token", player, 4))
    add_rule(self.get_location("Blue Gem Cup: Gem", player),
             lambda state: state.can_reach_entrance("Blue Cup Warp Pad", player) and state.has("Blue CTR Token", player, 4))
    add_rule(self.get_location("Yellow Gem Cup: Gem", player),
             lambda state: state.can_reach_entrance("Yellow Cup Warp Pad", player) and state.has("Yellow CTR Token", player, 4))
    add_rule(self.get_location("Purple Gem Cup: Gem", player),
             lambda state: state.can_reach_entrance("Purple Cup Warp Pad", player) and state.has("Purple CTR Token", player, 4))
    ...
    add_rule(self.get_location("Coco Park: Trophy Race", player),
             lambda state: state.can_reach_entrance("Coco Park Warp Pad", player) and state.has("Trophy", player, 4))
    add_rule(self.get_location("Coco Park: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Coco Park Warp Pad", player) and state.has("Key", player, 2) and state.can_reach_location("Coco Park: Trophy Race", player))
    ...
    add_rule(self.get_location("Tiger Temple: Trophy Race", player),
             lambda state: state.can_reach_entrance("Tiger Temple Warp Pad", player) and state.has("Trophy", player, 4))
    add_rule(self.get_location("Tiger Temple: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Tiger Temple Warp Pad", player) and state.has("Key", player, 2) and state.can_reach_location("Tiger Temple: Trophy Race", player))
    ...
    add_rule(self.get_location("Papu's Pyramid: Trophy Race", player),
             lambda state: state.can_reach_entrance("Papu's Pyramid Warp Pad", player) and state.has("Trophy", player, 6))
    add_rule(self.get_location("Papu's Pyramid: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Papu's Pyramid Warp Pad", player) and state.has("Key", player, 2) and state.can_reach_location("Papu's Pyramid: Trophy Race", player))
    ...
    add_rule(self.get_location("Dingo Canyon: Trophy Race", player),
             lambda state: state.can_reach_entrance("Dingo Canyon Warp Pad", player) and state.has("Trophy", player, 7))
    add_rule(self.get_location("Dingo Canyon: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Dingo Canyon Warp Pad", player) and state.has("Key", player, 2) and state.can_reach_location("Dingo Canyon: Trophy Race", player))
    ...
    add_rule(self.get_location("Papu Papu Garage: Boss Race", player),
             lambda state: state.can_reach_entrance("Papu Papu Garage Door", player) and state.has("Trophy", player, 8))
    
    # Rampage Ruins
    add_rule(self.get_location("Rampage Ruins: Crystal Bonus Round", player),
             lambda state: state.can_reach_entrance("Rampage Ruins Warp Pad", player) and state.has("Key", player, 2))
    ...
    add_rule(self.get_location("Blizzard Bluff: Trophy Race", player),
             lambda state: state.can_reach_entrance("Blizzard Bluff Warp Pad", player) and state.has("Trophy", player, 8))
    add_rule(self.get_location("Blizzard Bluff: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Blizzard Bluff Warp Pad", player) and state.has("Key", player, 3) and state.can_reach_location("Blizzard Bluff: Trophy Race", player))
    ...
    add_rule(self.get_location("Dragon Mines: Trophy Race", player),
             lambda state: state.can_reach_entrance("Dragon Mines Warp Pad", player) and state.has("Trophy", player, 9))
    add_rule(self.get_location("Dragon Mines: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Dragon Mines Warp Pad", player) and state.has("Key", player, 3) and state.can_reach_location("Dragon Mines: Trophy Race", player))
    ...
    add_rule(self.get_location("Polar Pass: Trophy Race", player),
             lambda state: state.can_reach_entrance("Polar Pass Warp Pad", player) and state.has("Trophy", player, 10))
    add_rule(self.get_location("Polar Pass: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Polar Pass Warp Pad", player) and state.has("Key", player, 3) and state.can_reach_location("Polar Pass: Trophy Race", player))
    ...
    add_rule(self.get_location("Tiny Arena: Trophy Race", player),
             lambda state: state.can_reach_entrance("Tiny Arena Warp Pad", player) and state.has("Trophy", player, 11))
    add_rule(self.get_location("Tiny Arena: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Tiny Arena Warp Pad", player) and state.has("Key", player, 3) and state.can_reach_location("Tiny Arena: Trophy Race", player))
    ...
    add_rule(self.get_location("Komodo Joe Garage: Boss Race", player),
             lambda state: state.can_reach_entrance("Komodo Joe Garage Door", player) and state.has("Trophy", player, 12))
    
    # Rocky Road
    add_rule(self.get_location("Rocky Road: Crystal Bonus Round", player),
             lambda state: state.can_reach_entrance("Rocky Road Warp Pad", player) and state.has("Key", player, 3))
    ...
    add_rule(self.get_location("N. Gin Labs: Trophy Race", player),
             lambda state: state.can_reach_entrance("N. Gin Labs Warp Pad", player) and state.has("Trophy", player, 12))
    add_rule(self.get_location("N. Gin Labs: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("N. Gin Labs Warp Pad", player) and state.has("Key", player, 4) and state.can_reach_location("N. Gin Labs: Trophy Race", player))
    ...
    add_rule(self.get_location("Cortex Castle: Trophy Race", player),
             lambda state: state.can_reach_entrance("Cortex Castle Warp Pad", player) and state.has("Trophy", player, 12))
    add_rule(self.get_location("Cortex Castle: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Cortex Castle Warp Pad", player) and state.has("Key", player, 4) and state.can_reach_location("Cortex Castle: Trophy Race", player))
    ...
    add_rule(self.get_location("Hot Air Skyway: Trophy Race", player),
             lambda state: state.can_reach_entrance("Hot Air Skyway Warp Pad", player) and state.has("Trophy", player, 13))
    add_rule(self.get_location("Hot Air Skyway: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Hot Air Skyway Warp Pad", player) and state.has("Key", player, 4) and state.can_reach_location("Hot Air Skyway: Trophy Race", player))
    ...
    add_rule(self.get_location("Oxide Station: Trophy Race", player),
             lambda state: state.can_reach_entrance("Oxide Station Warp Pad", player) and state.has("Trophy", player, 14))
    add_rule(self.get_location("Oxide Station: Sapphire Time Trial", player),
             lambda state: state.can_reach_entrance("Oxide Station Warp Pad", player) and state.has("Key", player, 4) and state.can_reach_location("Oxide Station: Trophy Race", player))
    ...
    add_rule(self.get_location("Pinstripe Garage: Boss Race", player),
             lambda state: state.can_reach_entrance("Pinstripe Garage Door", player) and state.has("Trophy", player, 16))
    
    # Nitro Court
    add_rule(self.get_location("Nitro Court: Crystal Bonus Round", player),
             lambda state: state.can_reach_entrance("Nitro Court Warp Pad", player) and state.has("Key", player, 4))
